...
const MeetingAgendaItems = () => {
  const agendaItems = [
    ...
    { number: 7, title: "Application of Southwestern to Amend", content: "Detailed content for item 7." },
    { number: 8, title: "Motion to extend time to act on motions", content: "Detailed content for item 8." },
    { number: 9, title: "Resolve Issues in Docket No. 53719", content: "Detailed content for item 9." },
    { number: 10, title: "Glotfelty Lays Out His Memo, 55338", content: "Detailed content for item 10." },
    { number: 11, title: "Motion to adopt PFD with modifications", content: "Detailed content for item 11." },
    { number: 12, title: "App CenterPoint Energy Houston Electric", content: "Detailed content for item 12." },
    { number: 13, title: "Thoughts on the Chairman's memo,55361", content: "Detailed content for item 13." },
    { number: 14, title: "Motion to deny CenterPoint's application,", content: "Detailed content for item 14." },
    { number: 15, title: "Certificate of Convenience and Necessity", content: "Detailed content for item 15." },
    { number: 16, title: "Montgomery County resident", content: "Detailed content for item 16." },
    { number: 17, title: "Montgomery County Resident", content: "Detailed content for item 17." },
    { number: 18, title: "Commission Staff - Online Outage Map, 56897", content: "Detailed content for item 18." }
  ];
